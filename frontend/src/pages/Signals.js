...
function TradingViewWidget({ symbol }) {
  ...
  useEffect(function() {
    ...
    wrapper.style.cssText = 'height:100%;width:100%;min-width:100%;max-width:100%;';
    ...
    // TradingView widget'ının yüklenmesini bekle ve stil düzeltmeleri yap
    setTimeout(() => {
            ...
            <div style={{ display:'flex', alignItems:'center', gap:10 }}>
              ...
              <div>
                ...
                <span style={{
                  marginLeft:10,
                  fontSize:13,
                  color: SIGNAL_COLORS[selected.signal_type]||'#718096',
                  fontWeight:700
                }}>
