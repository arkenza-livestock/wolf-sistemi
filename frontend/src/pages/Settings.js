        ...
        <div>
          ...
          <div className="card" style={{ marginBottom:16 }}>
            ...
            <div style={{ marginBottom:14 }}>
              <label style={{ display:'block', fontSize:12, color:'#718096', marginBottom:4, fontWeight:600 }}>
                Bot Token
              </label>
              <div style={{ fontSize:11, color:'#4a5568', marginBottom:5 }}>BotFather'dan alınan token</div>
            ...
            <div style={{ marginBottom:14 }}>
              ...
              <div style={{ fontSize:11, color:'#4a5568', marginBottom:5 }}>Mesajın gönderileceği chat/kanal ID</div>
              <input className="form-input"
                type="text"
            ...
            <div style={{ marginBottom:14 }}>
              ...
              <div style={{ fontSize:11, color:'#4a5568', marginBottom:5 }}>Bu skorun altındaki sinyaller Telegram'a gönderilmez</div>
              <input className="form-input"
                type="number"
                placeholder="50"
          ...
          <div className="card">
            ...
            <div style={{ marginBottom:14 }}>
              ...
              <div style={{ fontSize:11, color:'#4a5568', marginBottom:5 }}>Taranacak en iyi coin sayısı (önerilen: 50)</div>
              <input className="form-input"
                type="number"
                placeholder="50"
            ...
            <div style={{ marginBottom:14 }}>
              ...
              <div style={{ fontSize:11, color:'#4a5568', marginBottom:5 }}>24s minimum hacim (önerilen: 10000000)</div>
              <input className="form-input"
                type="number"
            ...
            <div style={{ marginBottom:14 }}>
              ...
              <div style={{ fontSize:11, color:'#4a5568', marginBottom:5 }}>Ortalamaya kıyasla hacim artışı (önerilen: 1.2)</div>
              <input className="form-input"
                type="number"
                step="0.1"
                placeholder="1.2"
          ...
          <div className="card">
            ...
            <div style={{ fontSize:12, color:'#718096', lineHeight:1.8 }}>
              <div style={{ marginBottom:8 }}>
                🐺 <b style={{ color:'#e2e8f0' }}>Wolf Sistemi</b> her 1 dakikada Binance'deki en yüksek hacimli coinleri tarar.
              </div>
              <div style={{ marginBottom:8 }}>
                📊 <b style={{ color:'#e2e8f0' }}>1m/5m/15m/30m</b> değişim analizi yapılır.
              </div>
              <div style={{ marginBottom:8 }}>
                🔥 <b style={{ color:'#e2e8f0' }}>Hacim Spike</b> tespiti ile gerçek hareketler yakalanır.
              </div>
              <div>
                🔄 Coin listesi <b style={{ color:'#e2e8f0' }}>her 10 taramada</b> otomatik güncellenir.
              </div>
            </div>
          </div>
        </div>
